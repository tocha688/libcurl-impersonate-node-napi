...
curl.setOptString(CurlOpt.Url, "https://postman-echo.com/post")
...
const data = Buffer.from("a=1&b=2&c=3")
...
// 直接获取完整的数据
console.log("\n=== Headers ===")
console.log(curl.getRespHeaders().toString("utf8"))
...
console.log("\n=== Body ===")
console.log(curl.getRespBody().toString("utf8"))
